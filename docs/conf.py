# -*- coding: utf-8 -*-
#
# pytest-notify documentation build configuration file, created by
...
project = u'pytest-notify'
copyright = u'2015, Alexandre Bonnetain'
author = u'Alexandre Bonnetain'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-notify Documentation',
     [author], 1)
]
